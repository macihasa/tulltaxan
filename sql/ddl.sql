...
CREATE TABLE IF NOT EXISTS additional_code_description_period (
    ...
    date_start TIMESTAMP,
    national INT,
    FOREIGN KEY (parent_sid) REFERENCES additional_code(sid)
);
CREATE TABLE IF NOT EXISTS additional_code_description (
    ...
    FOREIGN KEY (parent_sid) REFERENCES additional_code_description_period(sid)
);
...
CREATE TABLE IF NOT EXISTS certificate_description_period (
    ...
    date_start TIMESTAMP,
    national INT,
    FOREIGN KEY (parent_certificate_code, parent_certificate_type) REFERENCES certificate(certificate_code, certificate_type)
);
CREATE TABLE IF NOT EXISTS certificate_description (
    ...
    national INT,
    PRIMARY KEY (parent_sid, language_id),
    FOREIGN KEY (parent_sid) REFERENCES certificate_description_period(sid)
);
-- Goods Nomenclature
...
CREATE TABLE IF NOT EXISTS goods_nomenclature_indent (
    ...
    FOREIGN KEY (parent_sid) REFERENCES goods_nomenclature(sid)
);
...
CREATE TABLE IF NOT EXISTS goods_nomenclature_description (
    ...
    national INT,
    PRIMARY KEY (parent_sid, language_id),
    FOREIGN KEY (parent_sid) REFERENCES goods_nomenclature_description_period(sid)
);
...
CREATE TABLE IF NOT EXISTS geographical_area_membership (
    ...
    FOREIGN KEY (parent_sid) REFERENCES geographical_area(sid)
);
...
CREATE TABLE IF NOT EXISTS geographical_area_description (
    ...
    national INT,
    PRIMARY KEY (parent_sid, language_id),
    FOREIGN KEY (parent_sid) REFERENCES geographical_area_description_period(sid)
);
-- Measure
...
CREATE TABLE IF NOT EXISTS measure_condition (
    ...
    national INT,
    sequence_number INT,
    FOREIGN KEY (parent_sid) REFERENCES measure(sid)
);
...
CREATE TABLE IF NOT EXISTS measure_condition_component (
    ...
    FOREIGN KEY (parent_sid) REFERENCES measure_condition(sid)
);
...
CREATE TABLE IF NOT EXISTS monetary_exchange_rate (
    ...
    FOREIGN KEY (parent_sid) REFERENCES monetary_exchange_period(sid)
);
...
CREATE TABLE IF NOT EXISTS footnote_description (
    ...
    national INT,
    PRIMARY KEY (parent_sid, language_id),
    FOREIGN KEY (parent_sid) REFERENCES footnote_description_period(sid)
);
...
CREATE TABLE IF NOT EXISTS export_refund_nomenclature_indent (
    ...
    national INT,
    quantity_indents INT,
    FOREIGN KEY (parent_sid) REFERENCES export_refund_nomenclature(sid)
);
...
CREATE TABLE IF NOT EXISTS export_refund_nomenclature_description (
    ...
    national INT,
    PRIMARY KEY (parent_sid, language_id),
    FOREIGN KEY (parent_sid) REFERENCES export_refund_nomenclature_description_period(sid)
);
...
CREATE TABLE IF NOT EXISTS lookup_table_item (
    ...
    FOREIGN KEY (parent_sid) REFERENCES lookup_table(sid)
);
